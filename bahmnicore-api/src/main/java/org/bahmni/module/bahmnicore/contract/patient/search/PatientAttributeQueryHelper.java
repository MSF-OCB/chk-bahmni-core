...
public class PatientAttributeQueryHelper {
	...
	public String appendToJoinClause(String join){
		    ...
		    if(personAttributeResultsIds.size() > 0)
				...
				" LEFT OUTER JOIN concept_name cn on cast(cn.concept_id AS char) = pattr_results.value AND cn.concept_name_type = 'FULLY_SPECIFIED' AND attrt_results.format = 'org.openmrs.Concept'";
		    return join;
	}
